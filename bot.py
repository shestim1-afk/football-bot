...
def main():
    log.info("=" * 60)
    log.info("Football Bot v10.3 — Simplified Signals (game + top goalless SOT scorer)")
    log.info("=" * 60)
    ...
    log.info("")
    log.info("v10.3 CHANGES (simplified signals):")
    log.info("  SIGNAL FORMAT: now shows ONLY game name + top goalless SOT scorer")
    log.info("    (player with most SOT across both teams who has 0 goals)")
