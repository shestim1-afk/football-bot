...
def main():
    log.info("=" * 60)
    log.info("Football Bot v10.5.2 — SOT Velocity + xG Fix + Both-Team Signals")
    log.info("=" * 60)
    ...
    log.info("  Components: SOT(28) + InBox(18) + ShotVol(12) + xG(20) + DA(0-8,if) + Corners(4) + SOTvel(8) + Poss(3) + ACCEL(15)")
