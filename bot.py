    ...
    try:
        ...
        for update in results:
            ...
            if text == "/help":
                ...
                # v10.44k: Send pressure_polls.jsonl as a Telegram document
                if not os.path.exists(POLL_DATA_FILE):
                    ...
                    if file_size > 50 * 1024 * 1024:
                        send_telegram(client, f"File too large ({file_size / 1024 / 1024:.1f} MB > 50MB limit). Use /polls_today for today's data.")
                    else:
                        try:
                            with open(POLL_DATA_FILE, "rb") as f:
                                client.post(
