...
LEAGUE_IDS = {
    ...
    # (Parma vs Catania appeared under ID 137 with broken stats: 0% possession, 0 DA)
    191: "NB I (Hungary)",
}
...
def main():
    log.info("=" * 60)
    log.info("Football Bot v10.3.2 — 5'-85' Window + League ID Safety + Goalless SOT Lookup")
    log.info("=" * 60)
