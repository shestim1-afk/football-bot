...
def get_sot_based_interval(fid: int, base_interval: int) -> int:
    """v10.21: Pressure-aware polling interval with credit optimizations.

    v10.21 changes vs v10.13:
      - SOT=0 with state: 1.5x in ALL modes (was 1.0x NORMAL, saves ~1 poll/5min)
...
def main():
    log.info("=" * 60)
    log.info("Football Bot v10.21 — Credit optimizations + v10.20 window fixes")
    log.info("=" * 60)
