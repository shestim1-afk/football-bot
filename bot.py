...
def check_monitored_stats(
    ...
    v9.5.2: Uses /fixtures/statistics?fixture=X for each fixture
    individually, because the batched /fixtures?ids=X endpoint
    does NOT reliably include the statistics array.
    ...
    for fid in valid_ids:
        try:
            ...
            # Build a merged fixture dict from cached data + fresh stats
...
def main():
    log.info("=" * 60)
    log.info("Football Bot v9.5.2 — Pressure-First Ranking + Stats Fix")
    log.info("=" * 60)
