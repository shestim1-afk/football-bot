...
def main():
    log.info("=" * 60)
    log.info("Football Bot v10.23 — Unified batch polling + v10.22 edge-zone gate")
    log.info("=" * 60)
    ...
    with httpx.Client(timeout=30.0) as client:
        ...
        while True:
            ...
            if fast_monitored and budget != "STOP":
                ...
                # v10.23: ALWAYS poll ALL monitored fixtures together.
                # API cost is 1 credit per batch (up to 20 fixtures).
                # Previously, only "eligible" (due) fixtures were polled,
                # causing fast-polling fixtures to split into separate
                # 1-fixture API calls — burning extra credits per cycle.
                # Now ALL fixtures ride the fastest interval = 1 credit/cycle.
                # Slower fixtures get polled more often but cost nothing extra.
