...
def _goalburst_send_alert(entry: dict, label: str) -> None:
    ...
    API path, zero API credits. Informational: reports the empirical
    continuation so the user can compare it against the live Over price
